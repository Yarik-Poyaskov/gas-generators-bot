...
class ReportState(StatesGroup):
    ...
    pressure_intercooler_before = State()
    pressure_intercooler_after = State()
    pressure_engine_before = State()
    pressure_engine_after = State()
    battery_voltage_haas = State()
    total_mwh = State()
    total_hours = State()
    oil_sampling_limit = State()
    bearing_lubrication_limit = State()
